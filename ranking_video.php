...
//DBから取得して表示する．
$sql = "SELECT * FROM video LEFT OUTER JOIN account ON account.id = video.userid ORDER BY video.favorite DESC;";
...
echo ("<a href='viewer.php?id={$id}' class='rank'><video src=\"import_media.php?target=$target\" width=\"300\" height=\"170\" ></video><br>");
print "<h2>".$title."</h2>";
